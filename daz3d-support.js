...
class DazMeta {
    ...
    static get currentDazPageTypeAsStr() {
        //console.log(`${appId}:DazMain.currentDazPageTypeAsStr: this._currentPageListType:'${this._currentPageListType}', this._currentPageListType.type:'${this._currentPageListType?.type}'.`);
